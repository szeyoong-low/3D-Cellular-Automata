...
extern void render_info_buffer_init(GLuint *render_info_buffer, size_t sim_size,
                                    const RenderInfo *data);
extern void hidden_cell_buffer_init(GLuint *hidden_cell_buffer,
                                    size_t sim_size);
extern void instance_buffer_init(GLuint *instance_buffer, size_t sim_size);
extern void draw_indirect_buffer_init(GLuint *draw_indirect_buffer);
extern void sort_key_buffer_init(GLuint *sort_key_buffer, size_t sim_size);
